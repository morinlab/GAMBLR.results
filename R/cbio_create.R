...
#' }
#'
cbio_create = function(this_seq_type = "genome",
                       short_name = "GAMBL",
  ...
  #setup study
  ids = cbio_setup_study(seq_type_filter = this_seq_type,
  ...
  #check study
  cbio_study_check(data_clinical_samples_path = "data_clinical_samples.txt",
